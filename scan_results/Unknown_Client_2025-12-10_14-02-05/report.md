...
**Evidence:**
```json
{'port': 8080, 'service': 'HTTP-Alt', 'banner': 'HTTP/1.1 400 Bad Request\r\nDate: Wed, 10 Dec 2025 20:02:20 GMT\r\nContent-Length: 68\r\nConnection: close\r\nCache-Control: private, max-age=0, no-store, no-cache, must-revalidate, post-check=0, pre-check=0\r\nReferrer-Policy: same-origin\r\nExpires: Thu, 01 Jan 1970 00:00:01 GMT\r\nProxy-Status: Cloudflare-Proxy;error=http_request_error\r\nCF-RAY: 9abf56de4cfaab12-YYZ'}
```
...
**Evidence:**
```json
{'port': 443, 'protocol': 'TLSv1.3', 'cipher': ('TLS_AES_256_GCM_SHA384', 'TLSv1.3', 256), 'not_after': 'Feb 25 12:11:31 2026 GMT', 'days_until_expiry': 76, 'subject': 'commonName=ryanwilson.io', 'issuer': 'countryName=US, organizationName=Google Trust Services, commonName=WE1'}
```
...
**Evidence:**
```json
{'port': 8443, 'protocol': 'TLSv1.3', 'cipher': ('TLS_AES_256_GCM_SHA384', 'TLSv1.3', 256), 'not_after': 'Feb 25 12:11:31 2026 GMT', 'days_until_expiry': 76, 'subject': 'commonName=ryanwilson.io', 'issuer': 'countryName=US, organizationName=Google Trust Services, commonName=WE1'}
```
